<%-- 
    Document   : acceptuser
    Created on : 3 Jun, 2021, 3:11:07 PM
    Author     : SGKrishnan
--%>
...
<%!
 ...
 //establish the connectionjdbc:derby://localhost:1527/iplab1 [root on ROOT]
 con = DriverManager.getConnection("jdbc:derby://localhost:1527/iplab1","root","root");
...
<%
 ...
 out.println("<b><i><a href=examclient.html><font size=6 color=blue>Click Here totake test</font></i></a></b>");
